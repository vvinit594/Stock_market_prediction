...
export function AIPredictionPanel({
  ...
  return (
    ...
    >
      <Card className="overflow-hidden border-white/10 bg-white/5 backdrop-blur-sm transition-all hover:border-primary/20 hover:shadow-lg hover:shadow-primary/10">
        <CardHeader>
